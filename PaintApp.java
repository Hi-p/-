        ...
        public void mouseReleased(MouseEvent e) {
            if (currentmode.equals("DRAW")) {
                if (currentline != null && !currentline.isEmpty()) {
                    LineSegment newline = new LineSegment(currentline, currentColor, currentStrokeWidth, "DRAW", mirrormode); // 현재 그려진 선의 정보를 LineSegment 객체로 생성
                ...
                LineSegment newline = new LineSegment(shapePoints, currentColor, currentStrokeWidth, currentmode, mirrormode);
